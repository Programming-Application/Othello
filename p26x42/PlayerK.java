...
public class PlayerK extends ap26.Player {
  ...
  public PlayerK(Color color) {
    this(MY_NAME, color, new MyEval(), 4);
  }

  public PlayerK(String name, Color color, MyEval eval, int depthLimit) {
    super(name, color);
    this.eval = eval;
  ...
  public PlayerK(String name, Color color, int depthLimit) {
